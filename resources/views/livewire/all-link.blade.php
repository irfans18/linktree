<div>
   ...
   <div class="flex justify-center">
      <input type="text" wire:model="search" wire:keydown.enter="create" class="w-1/8 rounded-full" placeholder="search">
   </div>

   @if ($isOpen)
      <p class="text-center text-red-500">The link not found</p>
   @else
