<div>
   <div class="grid grid-cols-8 gap-2 py-4">
      ...
      <div class="px-8">
         ...
         <input  class=" rounded" wire:keydown.enter="create" wire:model="new.name" type="text">
      </div>
      <div></div>
      <div class="px-8">
         <label for="name">cname</label>
         <input  class="rounded" wire:keydown.enter="create" wire:model="new.cname" type="text">
      </div>
      <div></div>
      <div class="px-8">
         <label for="name">url</label>
         <input  class="rounded" wire:keydown.enter="create" wire:model="new.url" type="text">
      </div>
      <div></div>
      {{-- <div ><button wire:click="create" class="py-2 bg-blue-600 rounded text-white"><pre>  save  </pre></button></div> --}}
      <div class="pt-8"><button wire:click.prevent="create">
